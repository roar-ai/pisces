...
GPU_NUM=1 # 2,4,8
MODEL_PATH="/mnt/minhquan-local/data/hunyuan"
MODEL_TYPE="hunyuan"
DATA_MERGE_PATH="/mnt/minhquan-local/data/Image-Vid-Finetune-Src/merge.txt"
OUTPUT_DIR="/mnt/minhquan-local/data/Image-Vid-Finetune-HunYuan-ChatGPT-Prompts"
