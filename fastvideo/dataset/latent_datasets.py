...
class LatentDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return latent, prompt_embed, prompt_attention_mask, caption
...
def latent_collate_function(batch):
    ...
    latents, prompt_embeds, prompt_attention_masks, caption = zip(*batch)
    # calculate max shape
    ...
    return latents, prompt_embeds, latent_attn_mask, prompt_attention_masks, caption
